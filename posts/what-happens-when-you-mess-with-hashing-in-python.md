...
```
    ...
    <ipython-input-4-173238e7b4db> in <module>()
    ----> 1 hash([]) # An empty list
...
```
    ...
    <ipython-input-34-1e95f5367377> in <module>()
    ----> 1 hash(NH)
...
```
    ...
    <ipython-input-45-f23df7077ea7> in <module>()
    ----> 1 d[b]
    

    KeyError: <__main__.Bad object at 0x101f79d90>
...
```
    ...
    <ipython-input-54-4405e5352cc2> in <module>()
    ----> 1 DHset.remove(DH)
    

    KeyError: <__main__.DifferentHash object at 0x101f79f50>
